...
const eventData = {
  "official-launch": {
    ...
    coverImage: "/images/launch event.jpg"
  },
  "lead-intentionally": {
    ...
    attendees: 120,
    description: "An intensive workshop designed to empower alumni with leadership skills and strategies for creating meaningful impact in their respective fields. This virtual gathering brings together experienced leaders and change-makers.",
    highlights: [
    ...
    speakers: [
      {
        ...
        topic: "Transformational Leadership in Practice"
      }
    ],
    outcomes: [
      "Development of personal leadership manifestos",
      "Creation of action plans for impact",
      "Formation of peer mentoring circles"
    ],
    gallery: [
      "/images/Sustainable Agriculture Fellows(1).jpg"
    ],
    coverImage: "/images/Sustainable Agriculture Fellows(1).jpg"
  },
  "power-of-networks": {
    title: "The Power of Networks: Turning Connections",
    date: "May 12, 2025",
    time: "3:00 PM - 5:00 PM EAT",
    location: "Hybrid Event - Nairobi & Virtual",
    attendees: 85,
    description: "Explore the transformative power of professional networks and learn how to leverage connections for collective impact in African agriculture and food systems.",
    highlights: [
      "Network mapping workshop",
      "Success stories from alumni collaborations",
      "Strategic partnership building",
      "Digital networking tools and platforms"
    ],
    speakers: [
      {
        name: "Ms. Aisha Mohammed",
        role: "Network Strategy Consultant",
        topic: "Building Meaningful Professional Connections"
      }
    ],
    outcomes: [
      "Creation of alumni networking groups",
      "Launch of collaboration platform",
      "Development of partnership frameworks"
    ],
    gallery: [
      "/images/Sustainable Land Use Fellows.jpg"
    ],
    coverImage: "/images/Sustainable Land Use Fellows.jpg"
  }
};
